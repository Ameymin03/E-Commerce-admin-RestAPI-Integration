...
const response = await axios.post("https://crudcrud.com/api/5bb97bd82a694426847ce9e07cc71cd6/task", productDetails);

// Fetch the updated product list
axios.get("https://crudcrud.com/api/5bb97bd82a694426847ce9e07cc71cd6/task")
  .then(response => {
...
async function getProducts() {
  try {
    const response = await axios.get("https://crudcrud.com/api/5bb97bd82a694426847ce9e07cc71cd6/task");
...
function removeproduct(product, listItem) {
  if (confirm('Do you want to delete this product?')) {
    axios.delete(`https://crudcrud.com/api/5bb97bd82a694426847ce9e07cc71cd6/task/${product._id}`)
      .then(() => {
        listItem.remove();
