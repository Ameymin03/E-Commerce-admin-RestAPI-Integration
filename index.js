async function handleFormSubmit(event) {
    ...
    try {
      const response = await axios.post("https://crudcrud.com/api/21d28a3452cd4e9f845c67c745d4d55a/task", productDetails);
  ...
  async function getProducts() {
    try {
      const response = await axios.get("https://crudcrud.com/api/21d28a3452cd4e9f845c67c745d4d55a/task");
  ...
  function removeproduct(product, listItem) {
    if (confirm('Do you want to delete this product?')) {
      axios.delete(`https://crudcrud.com/api/21d28a3452cd4e9f845c67c745d4d55a/task/${product._id}`)
        .then(() => {
          listItem.remove();
